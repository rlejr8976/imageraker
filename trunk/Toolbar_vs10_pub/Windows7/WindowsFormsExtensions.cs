...
namespace Windows7.DesktopIntegration.WindowsForms
{
    ...
    public static class WindowsFormsExtensions
    {
        ...
        public static void SetAppId(Form form, string appId)
        {
        ...
        public static string GetAppId(Form form)
        {
        ...
        /// </summary>
        /// <param name="form">The form.</param>
        public static void EnableCustomWindowPreview(Form form)
        {
        ...
        /// </summary>
        /// <param name="form">The form.</param>
        public static void DisableCustomWindowPreview(Form form)
        {
        ...
        public static void SetIconicThumbnail(Form form, Bitmap bitmap)
        {
        ...
        public static void SetPeekBitmap(Form form, Bitmap bitmap, bool displayFrame)
        {
        ...
        public static void SetTaskbarOverlayIcon(Form form, Icon icon, string description)
        {
        ...
        public static void SetTaskbarProgress(Form form, float percent)
        {
            Windows7Taskbar.SetProgressState(
                form.Handle, Windows7Taskbar.ThumbnailProgressState.Normal);
            Windows7Taskbar.SetProgressValue(
        ...
        public static void SetTaskbarProgressState(Form form, Windows7Taskbar.ThumbnailProgressState state)
        {
        ...
        public static void SetThumbnailTooltip(Form form, string tooltip)
        {
